...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.accordion = function () {
  ...
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      ...
      if (Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).containsClass(headActiveClass)) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(e => {
      e.preventDefault();
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(target).fadeIn(200);
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function () {
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    modal.setAttribute('id', this[i].getAttribute('data-target').slice(1)); // btns = {settings: [[text, classNames=[], close, cb]]}
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].getAttribute('data-target')).fadeIn(200);
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttribute = function (nameAttr, value) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.removeAttribute = function (nameAttr) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.getAttribute = function (atrributeName) {
  for (let i = 0; i < this.length; i++) {
    return this[i].getAttribute(atrributeName);
  }
};

_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleAttribute = function (nameAttr) {
  for (let i = 0; i < this.length; i++) {
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    ...
    }], ['another button', ['btn-warning', 'ml10'], false, () => {
      alert('Hello world');
    }]]
  }
}));
